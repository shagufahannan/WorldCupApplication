...
import com.aiub.worldcup2018androidsix.NavigationDrawerFragments.privacy_fragment;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_schedule) {
            ...
            privacy_fragment privacy_fragment=new privacy_fragment();
            privacy_fragment.show(getSupportFragmentManager(), "Dialog");
